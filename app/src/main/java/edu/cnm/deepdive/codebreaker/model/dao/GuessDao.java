...
public interface GuessDao {
  ...
  @Update
  Single<Integer> update(Guess guess);//return type is number of records affected by the operation
  ...
  @Query("SELECT * FROM guess ORDER BY created DESC") //we named our table guess
