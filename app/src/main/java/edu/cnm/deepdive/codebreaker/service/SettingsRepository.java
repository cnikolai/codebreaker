...
public class SettingsRepository {
  ...
  public Observable<Integer> getCodeLengthPreference() {
    return Observable.create((emitter) -> {
      ...
      // Emit code length preference.
      emitChangedPreferences(preferences, codeLengthPrefKey);//puts data with current value, next sends data if user changes it.
    });
  }
